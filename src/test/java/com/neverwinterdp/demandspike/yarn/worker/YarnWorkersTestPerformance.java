...
public class YarnWorkersTestPerformance extends AbstractMiniClusterUnitTest {
  ...
  public void testYarnContainers() throws Exception {
    ...
    String[] args = {
        ...
        "63200", "--app-num-of-worker", "2", "--conf:yarn.resourcemanager.scheduler.address=0.0.0.0:8030",
        "--conf:broker-connect=http://127.0.0.1:7080/message", "--conf:max-duration=30000", "--conf:message-size=1024",
