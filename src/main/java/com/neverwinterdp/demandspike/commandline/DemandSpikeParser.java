...
public class DemandSpikeParser {
	...
	private void launchStandAloneTest(RunCommands commands) throws IOException {
		...
		DemandSpikeJobConfig config = new DemandSpikeJobConfig(commands.targets,  commands.method, commands.cLevel,
				commands.messageSize, commands.time, commands.nMessages,
				commands.sendPeriod);
